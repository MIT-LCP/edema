	...
	if (length($line) > 1) {
	    $line =~ tr/[a-z]/[A-Z]/;  # Convert the line to upper case.
            ...
            if ($line =~ /omeprazole|prilosec|esomeprazole|nexium|pantoprazole|protonix|lansoprazole|prevacid|rabeprazole|aciphex/i ) {
                ...
                $drugs{$line} = 0b0100;
                # Diuretics
            } elsif ( $line =~ /furosemide|lasix|hydrochlorothiazide|hctz|spironolactone|aldactone|torsemide|demadex|acetazolamide|diamox|triamterene|dyrenium|bumetanide|bumex|ethacrynic acid|edecrin|eplerenone|inspra|amiloride|midamor|moduretic|lotrel|tenoretic|lotensin|ziac|capozide|vaseretic|lexxel|apresazide|prinzide|zestoretic|hyzaar|aldoril|corzide|inderide|aldactazide|dyazide|maxide|
/i ) {
                $drugs{$line} = 0b0010;
